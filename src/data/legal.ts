  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Die Snapshots des Registers sind versioniert und öffentlich abrufbar; eine Entfernung wirkt für künftige Stände. Ältere, bereits veröffentlichte Stände bleiben als Archiv bestehen — ebenso wie frühere Fassungen in der Versionsgeschichte der zugehörigen öffentlichen Code-Repositorien. Darauf wird hier ausdrücklich hingewiesen.',
      ],
    },
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Snapshots of the register are versioned and publicly retrievable; a removal takes effect for future snapshots. Earlier, already published snapshots remain as an archive, as do earlier states in the version history of the associated public code repositories — this is stated here explicitly.',
      ],
    },
