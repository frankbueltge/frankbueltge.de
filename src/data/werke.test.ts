...
describe('WERKE_HOLDINGS (/experiments register)', () => {
  ...
  it('renders newest first — the curated 2026-08-05 ranking is dissolved (Frank, 2026-08-14)', () => {
    // "mach mal neue werke oben, also die reihenfolge die wir zuletzt festgelegt haben
    // wieder auflösen" — recency order, derived from WERKE_CHRONO, no manual list to go stale.
