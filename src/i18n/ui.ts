...
export const ui = {
  de: {
    ...
    'tl.title': 'Delve into the intricate realm',
    ...
    'rn.sub': 'Ein Test, der angeblich gefälschte Zahlen erkennt — und wie oft er sich irrt.',
    'rn.empty': 'Die erste Verhandlung folgt mit dem nächsten nächtlichen Lauf.',
    'gf.title': 'The Ghost Fleet',
    'gf.sub': 'Schiffe, die ihren Transponder bewusst abschalten, um zu verschwinden — gezählt, wo sie sich verstecken.',
    'gf.empty': 'Die erste Feststellung folgt mit dem nächsten nächtlichen Lauf.',
  ...
  en: {
    ...
    'rn.empty': 'The first hearing follows with the next nightly run.',
    'gf.title': 'The Ghost Fleet',
    'gf.sub': 'Ships that switch off their transponder on purpose to vanish — counted where they hide.',
    'gf.empty': 'The first finding follows with the next nightly run.',
