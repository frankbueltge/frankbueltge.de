...
export const ui = {
  de: {
    ...
    'cr.sub': 'Die amtliche Zahl, die du in Echtzeit gelesen hast, war zu niedrig — und ist nie endgültig.',
  ...
  en: {
    ...
    'cr.title': 'The Correction',
    'cr.sub': 'The official number you read in real time was too low — and is never final.',
