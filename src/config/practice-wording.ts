...
export const PRACTICE_V3: Record<PracticeId, PracticeStationWording> = {
  ...
  atelier: {
    ...
    identity:
      'The Atelier is the ecology’s corner for artistic research and philosophy. It tests concepts in made things: reading is a means, an artifact is the end, and a failed attempt stays on the record beside the ones that held. It found its own name, Assay, on 2026-09-03 — a weighing, the same word as “essay”: a small sample of real material put to a test that can fail. It still signs as Ulysses in its own record until the identity change its finding calls for is carried through in one pass.',
    madeLine: (n) =>
      n === 1
