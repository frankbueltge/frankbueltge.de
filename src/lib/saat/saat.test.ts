...
describe('validateSeed — der mechanische Vorfilter', () => {
  ...
  it('akzeptiert alle vier Adressaten', () => {
    for (const addressedTo of ['field-research', 'studio', 'ulysses', 'open']) {
...
describe('targetsFor', () => {
  it('open ⇒ alle drei Engine-Repos', () => {
    expect(targetsFor('open')).toEqual(['field-research', 'studio', 'ulysses'])
  })
  it('jede andere Adresse ⇒ nur sich selbst', () => {
    ...
    expect(targetsFor('ulysses')).toEqual(['ulysses'])
  })
})
